...
hl.on("hyprland.start", function()
  ...
  hl.exec_cmd("killall xdg-desktop-portal xdg-desktop-portal-hyprland 2>/dev/null")
...
-- Animations (all enabled, as per the old "enabled = yes, please :)")
hl.animation({ leaf = "global", enabled = true, speed = 10, bezier = "default" })
hl.animation({ leaf = "border", enabled = true, speed = 5, bezier = "easeOutQuint" })
hl.animation({ leaf = "windows", enabled = true, speed = 2, bezier = "easeOutQuint", style = "gnomed" })
hl.animation({ leaf = "windowsIn", enabled = true, speed = 3, bezier = "easeOutQuint", style = "gnomed" })
hl.animation({ leaf = "windowsOut", enabled = true, speed = 3, bezier = "linear", style = "gnomed" })
...
hl.animation({ leaf = "workspacesIn", enabled = true, speed = 2, bezier = "easeInOutCubic", style = "slidefade" })
hl.animation({ leaf = "workspacesOut", enabled = true, speed = 2, bezier = "easeInOutCubic", style = "slidefade" })
...
hl.bind(mainMod .. " + B", hl.dsp.exec_cmd(bgChanger))
hl.bind(mainMod .. " + END", hl.dsp.exec_cmd(sysMonitor))
